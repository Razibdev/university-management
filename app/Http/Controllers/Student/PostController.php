...
class PostController extends Controller
{
    public function addPost(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            $post = new Post();
            $post->type = $data['type'];
            $post->designation_id = Auth::guard('student')->user()->id;
        ...
        return view('student.post.add_post');
    }


    public function viewPost(){
        Session::put('page', 'posts');
        $posts = Post::where(['type'=> 'student', 'designation_id'=> Auth::guard('student')->user()->id])->get();
        return view('student.post.view_post', compact('posts'));
    }
...
//       echo '<pre>'; print_r($delete_category); die();
    ...
    public function editPost(Request $request, $id){
        ...
        return view('student.post.edit_post', compact('postDetails'));
    }
}
