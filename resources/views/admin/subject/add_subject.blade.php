            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @endif
                        <!-- form start -->
                            <form role="form" method="POST" action="{{url('admin/add-subject')}}">
                                {{csrf_field()}}
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="name" name="name" placeholder="Enter Subject Name" >
                                            </div>

                                            <div class="form-group">
                                                <label for="code">Subject Code</label>
                                                <input class="form-control" id="code" name="code" placeholder="Enter Subject Code" >
                                            </div>
