                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="{{url('admin/add-section')}}" class="btn btn-success pull-right">Add Section</a>
                                    ...
                                    @foreach($sections as $section)
                                        <tr>
                                            ...
                                            <td> <input type="checkbox" class="js-switch" data-id="{{$section->id}}" name="status" {{$section->status == 1 ? 'checked' : ''}} />
                                               <td> <a title="Delete Setion" href="javascript:void(0)" name="section" data-id="{{$section->id}}" class="btn btn-danger confirmDelete"><i class="fas fa-trash"></i></a></td>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
