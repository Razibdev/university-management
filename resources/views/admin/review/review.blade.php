                                ...
                                <table id="reviews" class="table table-bordered table-striped">
                                    ...
                                    @foreach($reviews as $review)
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('/image/teacher_image/'.$review->teacher->profile_image)}}" style="width: 70px; height: 70px;" alt=""></td>
                                            <td>{{$review->book->book_name}}</td>
                                            <td> {{ \Illuminate\Support\Str::limit($review->message, 100) }}</td>
                                            <td> <a title="Delete Review" href="javascript:void(0)" name="review" data-id="{{$review->id}}" class="btn btn-danger confirmDelete"><i class="fas fa-trash"></i></a></td>
                                            @endif

                                        @if($review->type == 'student')
