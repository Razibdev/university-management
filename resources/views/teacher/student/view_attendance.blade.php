...
@push('js')
    ...
    <script>
        ...
        $('#subject').on('change', function (e) {
            ...
            $.get('/subject-student?subject_id='+subject_id, function (data) {
                $('#student').empty();
                $('#student').append('<tr><td></td><td></td><td></td><td></td><td></td><td></td></tr>');
                $.each(data, function (index, student) {
                    console.log(student);
                    $('#student').append('<tr><td><input type="hidden" value="'+index+'" name="index"><input type="hidden" value="'+student.id+'" name="student_id'+index+'"><input type="hidden" value="'+student.student.exam_roll+'" name="exam_roll'+index+'">'+student.student.exam_roll+'</td><td>'+ student.department.name+'</td><td>'+ student.batch.name+'</td><td>'+ student.student.name+'</td><td> <a title="Edit Product" class="btn btn-success" href="/teacher/attendance-view/'+student.student.id+'/subject/'+student.subject.id+'"><i class="fas fa-edit"></i></a></td></tr> ');
                });
            });
        });
    </script>
