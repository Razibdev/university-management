...
@section('content')
    ...
    <div class="search-box">
        <div class="serach-form">
            ...
            <form action="{{url('/teacher-search')}}">
    ...
    <section id="page-banner" class="pt-105 pb-130 bg_cover" data-overlay="8" style="background-image: url(front/images/page-banner-3.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
